...
export default async function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* ── Privacy Statement ───────────────────────────────────── */}
      <section id="privacy-statement" className="border-t border-border/60 bg-muted/30">
        <div className="mx-auto max-w-5xl px-4 py-14 sm:px-6 sm:py-16">

          {/* Test-purposes callout */}
          <div className="mb-10 rounded-xl border border-amber-300 bg-amber-50 px-5 py-4 dark:border-amber-700 dark:bg-amber-950/30">
            <p className="text-[13px] font-semibold uppercase tracking-wide text-amber-800 dark:text-amber-400">
              Test Service
            </p>
            <p className="mt-1.5 text-[13px] leading-relaxed text-amber-900 dark:text-amber-300">
              PROLOG is currently a test application. You should not enter, speak, or upload any real patient data, sensitive clinical information, or data about real individuals. Do not use this service in a live clinical setting or with any actual patient details.
            </p>
          </div>

          <h2 className="text-lg font-semibold tracking-tight sm:text-xl">Privacy Statement</h2>
          <p className="mt-1 text-[12px] text-muted-foreground">Last updated: April 2026</p>

          <div className="mt-8 space-y-8 text-[13.5px] leading-relaxed text-foreground/80">

            {/* 1 */}
            <div>
              <h3 className="mb-2 text-[14px] font-semibold text-foreground">1. About Us</h3>
              <p>
                PROLOG is a voice-based clinical communication training simulator built for NHS Scotland and HSCP staff. This notice explains how we collect, use, and protect your personal information when you use the service. For any privacy-related queries, please contact us using the details on our website.
              </p>
            </div>

            {/* 2 */}
            <div>
              <h3 className="mb-2 text-[14px] font-semibold text-foreground">2. What Personal Information We Collect</h3>
              <p className="mb-3">When you use PROLOG, we may collect and process the following information:</p>
              <ul className="space-y-2 pl-4">
                {[
                  ["Account information", "Your name, email address, and role (trainee, educator, or administrator) when you register."],
                  ["Voice and audio data", "Audio recordings of your voice during simulation sessions, transmitted to third-party providers for real-time processing. Sessions may be recorded as audio files and stored for post-session review."],
            ...
            {/* 3 */}
            <div>
              <h3 className="mb-2 text-[14px] font-semibold text-foreground">3. How We Use Your Information</h3>
            ...
            {/* 4 */}
            <div>
              <h3 className="mb-2 text-[14px] font-semibold text-foreground">4. Legal Basis for Processing</h3>
              <p className="mb-3">We process your personal information on the following bases:</p>
              <ul className="space-y-1.5 pl-4">
                {[
            ...
            {/* 5 */}
            <div>
              <h3 className="mb-2 text-[14px] font-semibold text-foreground">5. Your Voice and Session Data</h3>
              <p>
                Your voice is transmitted to OpenAI's Realtime API during simulation sessions for the purpose of generating AI patient responses and automated transcription. Session audio may be recorded and stored for review. You are responsible for ensuring that no real patient data or sensitive clinical information is spoken or described during simulation sessions.
              </p>
            </div>

            {/* 6 */}
            <div>
              <h3 className="mb-3 text-[14px] font-semibold text-foreground">6. Third-Party Service Providers</h3>
              <p className="mb-4">
                We do not sell your personal information. To deliver the service, we use the following third-party providers who may process your data on our behalf:
              </p>
              <div className="space-y-4">
                {[
                  {
                    ...
                    desc: "Stores all application data including user accounts, scenario content, session transcripts, performance scores, reflections, educator notes, and session audio recordings. Also provides user authentication (email/password sign-in). Supabase is SOC 2 Type II certified, HIPAA compliant, and provides a GDPR-compliant Data Processing Agreement. Data is encrypted at rest (AES-256) and in transit (TLS). Our project is hosted in a European AWS region.",
                  },
                  {
                    name: "OpenAI",
                  ...
                  },
                  {
                    ...
                    desc: "Hosts and serves the website and API routes. Serverless functions are configured to run in European regions where possible. Vercel is certified under the EU-U.S. Data Privacy Framework including the UK Extension. Some network-level data (such as IP addresses) may be processed through US-based infrastructure for security purposes (e.g. DDoS protection).",
                  },
                ].map(({ name, role, desc }) => (
                  <div key={name} className="rounded-lg border border-border/60 bg-card px-4 py-3.5">
                    <p className="text-[13.5px]">
                      <span className="font-semibold text-foreground">{name}</span>
                      <span className="ml-1.5 text-muted-foreground">({role})</span>
                      {" — "}
                      {desc}
                    </p>
                  </div>
              ...
              <p className="mt-4 text-[12.5px] text-muted-foreground">
                All providers are contractually required to handle your data securely and only for the purposes of delivering the service. Data Processing Agreements are in place with each provider.
              </p>
            </div>

            {/* 7 */}
            <div>
              <h3 className="mb-2 text-[14px] font-semibold text-foreground">7. International Data Transfers</h3>
              <p>
                We are based in the United Kingdom and use European server regions wherever available. However, some of our third-party providers are US-based companies and limited data transfers to the United States may occur. Where this is the case, transfers are protected by appropriate safeguards including Data Processing Agreements and, where available, certification under the EU-U.S. Data Privacy Framework (including the UK Extension), ensuring your data receives an adequate level of protection in compliance with UK GDPR.
              </p>
            </div>

            {/* 8 */}
            <div>
              <h3 className="mb-2 text-[14px] font-semibold text-foreground">8. Data Retention</h3>
              <p>
                We retain your personal information only for as long as necessary to provide the service. Session transcripts, audio recordings, and conversation data are retained for the duration of your active use and are deleted within a reasonable period after you cease using the service or request deletion.
              </p>
            </div>

            {/* 9 */}
            <div>
              <h3 className="mb-2 text-[14px] font-semibold text-foreground">9. How We Protect Your Information</h3>
              <p className="mb-3">We take appropriate technical and organisational measures to protect your personal information, including:</p>
              <ul className="space-y-1.5 pl-4">
                {[
            ...
            {/* 10 */}
            <div>
              <h3 className="mb-2 text-[14px] font-semibold text-foreground">10. Cookies</h3>
              <p className="mb-3">We use cookies to keep the site functioning correctly. These include:</p>
              <ul className="space-y-1.5 pl-4">
                {[
                  ["Essential cookies", "Required for the site to operate, including session management and authentication state."],
                ].map(([label, desc]) => (
                  <li key={label} className="flex gap-2">
                    <span className="mt-0.5 shrink-0 text-muted-foreground">•</span>
                    <span><span className="font-medium text-foreground">{label}:</span> {desc}</span>
            ...
            {/* 11 */}
            <div>
              <h3 className="mb-2 text-[14px] font-semibold text-foreground">11. Your Rights</h3>
            ...
            {/* 12 */}
            <div>
              <h3 className="mb-2 text-[14px] font-semibold text-foreground">12. Complaints</h3>
              <p>
                If you are unhappy with how we handle your personal information, you have the right to raise a concern with the Information Commissioner's Office (ICO) at{" "}
                <a href="https://ico.org.uk" target="_blank" rel="noopener noreferrer" className="underline underline-offset-2 hover:text-foreground">
                  ico.org.uk
                </a>.
              </p>
            </div>
            ...
            {/* 13 */}
            <div>
              <h3 className="mb-2 text-[14px] font-semibold text-foreground">13. Updates</h3>
              <p>
                We may update this privacy statement from time to time. Any changes will be posted on this page. We encourage you to review it periodically.
              </p>
            </div>
      ...
      <footer className="border-t border-border/60">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-6 sm:px-6">
          ...
          <div className="flex items-center gap-4">
            <a href="#privacy-statement" className="text-[12px] text-muted-foreground hover:text-foreground transition-colors">
              Privacy Statement
            </a>
